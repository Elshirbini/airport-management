...
export class CreateAdminAirportStaff1789393828097 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."notifications_type_enum" AS ENUM('BOOKING_CONFIRMATION', 'FLIGHT_DELAY', 'welcome', 'otp-confirmation', 'reset-password')`);
        ...
        await queryRunner.query(`ALTER TABLE "airport_admins" ADD CONSTRAINT "FK_a44720a930d3f058673e5585e7a" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "airport_admins" ADD CONSTRAINT "FK_f395d500c1b0b1fbacb904fb46d" FOREIGN KEY ("airport_id") REFERENCES "airports"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "staff" ADD CONSTRAINT "FK_d2a2e11ac9b7e2099df78b36fcb" FOREIGN KEY ("airport_id") REFERENCES "airports"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "staff" DROP CONSTRAINT "FK_d2a2e11ac9b7e2099df78b36fcb"`);
        await queryRunner.query(`ALTER TABLE "staff" DROP CONSTRAINT "FK_cec9365d9fc3a3409158b645f2e"`);
        await queryRunner.query(`ALTER TABLE "airport_admins" DROP CONSTRAINT "FK_f395d500c1b0b1fbacb904fb46d"`);
        await queryRunner.query(`ALTER TABLE "airport_admins" DROP CONSTRAINT "FK_a44720a930d3f058673e5585e7a"`);
        await queryRunner.query(`CREATE TYPE "public"."notifications_type_enum_old" AS ENUM('BOOKING_CONFIRMATION', 'FLIGHT_DELAY', 'EMAIL_VERIFICATION', 'welcome', 'otp-confirmation', 'reset-password')`);
